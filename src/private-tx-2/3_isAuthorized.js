...
const { httpRpcAlice, httpRpcBob, httpRpcCharlie } = utils.connectionsHTTPRPC();
    ...
    function isAuthorize() {
        ...
        console.log("Checking if Charlie is authorized");
        ...
        const encodedData = privateContract.methods.isAuthorized(alice).encodeABI();
        ...
        console.log("Answer:");
        console.log(web3.utils.hexToNumber(callRes));
    });
};
